...
def retrieve_drinks():
    try:
        # Fetach all drinks in the short format and return them
        drinks_query = Drink.query.order_by('id').all()

        if len(drinks_query) == 0:
            raise werkzeug.exceptions.NotFound
        """ print("check 3")
        print(drinks_query[0])
        print(drinks_query[0].id)
        print(drinks_query[0].title)
        print(drinks_query[0].recipe)
        print(type(drinks_query[0]))
        print(type(drinks_query))
        data = {
            "id": drinks_query[0].id,
            "title": drinks_query[0].title,
            "recipe": drinks_query[0].recipe
        } """
